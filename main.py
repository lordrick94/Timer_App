...
class MainLayout(Screen):
    ...
    def readability(self, widget):
        ...
        if '.' in self.Readability:
            self.Readability = self.Readability.replace('.', ',')
    ...
    def certificate_generator(self):
        ...
        try:
            ...
            error_xl = f"Close Template.xlsx first then generate certificate"
        ...
        try:
            ...
            print(f"Close {Certificate_No}.docx first then generate certificate")
