...
class MainLayout(TabbedPanel):
    ...
    def certificate_generator(self):
        ...
        wb.save(path + f"{self.certificate_number}.xlsx")
        ...
        r = para.add_run()
        r.add_picture("tbs logo.png")
        r_space_1 = para.add_run("\t\t\t\t\t\t\t\t")
        r_1 = para.add_run()
        r_1.add_picture("sadcas.png")
        ...
        doc.save(f'Certificates\{Certificate_No}.docx')
        os.system(f"start Certificates\{Certificate_No}.docx")
